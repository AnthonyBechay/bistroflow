...
async function seedUser(email, name, passwordPlain) {
  ...
  await prisma.recipeIngredient.create({
    data: { quantity: 0.5, unit: 'kg', recipeId: recipePasta.id, ingredientId: ingredientPasta.id },
  });
  await prisma.recipeIngredient.create({
    data: { quantity: 1.0, unit: 'kg', recipeId: recipePasta.id, ingredientId: ingredientTomato.id },
  });
  await prisma.recipeIngredient.create({
    data: { quantity: 0.05, unit: 'liters', recipeId: recipePasta.id, ingredientId: ingredientOliveOil.id },
  });
